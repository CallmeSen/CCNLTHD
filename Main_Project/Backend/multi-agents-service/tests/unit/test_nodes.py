...
class TestFetchMarketNewsNode:
    ...
    @patch("src.fin_agents.agents.news_agent.fetch_market_news")
    def test_returns_market_news(self, mock_fetch, sample_state):
        from src.fin_agents.agents.news_agent import NewsAgent
...
class TestFetchDataNodeWrapper:
    ...
    @patch("src.fin_agents.agents.data_agent.fetch_data_node")
    def test_returns_financial_data(self, mock_fetch, sample_state):
        import pandas as pd
        from src.fin_agents.agents.data_agent import DataAgent
...
class TestGenerateCommentaryNode:
    ...
    def test_returns_commentary(self, sample_state, sample_metrics):
        from src.fin_agents.agents.commentary_agent import CommentaryAgent
...
class TestStructureOutputNode:
    ...
    def test_returns_final_report(self, sample_state, sample_metrics):
        from src.fin_agents.agents.report_agent import ReportAgent
...
class TestHandleErrorNode:
    ...
    def test_basic_error(self):
        from src.fin_agents.agents.report_agent import ErrorAgent

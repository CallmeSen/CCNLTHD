...
_COMMENTARY_LLM = "src.fin_agents.agents.commentary_agent.get_shared_llm"
...
class TestFullWorkflow:
    ...
    def _run_graph(self, request: str, lang: str, sample_financial_data):
        ...
        from src.fin_agents.graphs.workflow.stock_advisory.builder import compile_stock_advisory_graph
